  ...
  return (
    <ScrollView>
      <View style={[[styles.photoContainer, globalStyles.secondary]]}>
        ...
        <Text style={[globalStyles.text, styles.textDescription, {marginTop: 20}]}>Front-end Developer y un poquito de Back-end también :)</Text>
      </View>
      <Spacer>
        <View style={styles.container}>
        <View style={styles.containerAllResume}>
          <View style={styles.containerTitle}>
            <Text style={[styles.title, globalStyles.text]}>Resúmen</Text>
          </View>
          ...
          <View style={styles.containerResume}>
            ...
            <View style={styles.containerRowResume }>
              ...
              <Text style={[{color: globalStyles.text.color}]}>Experiencia</Text>
            </View>
          </View>
          ...
          <View style={styles.containerSkillsBlank}>
            <View style={styles.containerTitle}>
              <Text style={[styles.title, globalStyles.text]}>Lenguajes de Programación</Text>
            </View>
                ...
                <View style={styles.containerCircle}>
                  <Text style={[globalStyles.text, styles.text]}>Javascript</Text>
                    <ProgressCircle
                      ...
                      bgColor={globalStyles.white.backgroundColor}
                    >
          ...
          <View style={styles.containerTitle}><Text style={[styles.title, globalStyles.text, { marginTop: 30}]}>Skills Personalidad</Text></View>
          <View style={styles.containerSkills}>
            <View style={styles.containerSkillsRow}>
              <View style={styles.containerCircle}>
